...
<body>
    ...
    <!-- Start Categories of The Month -->
		<form class="form-total" action="<c:url value='/faqans/modify'/>" method="post" name="faqmodiForm" enctype="multipart/form-data">
        ...
        <div class="table-box col-lg second-section">
                ...
                <div>
                    <div>
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="FaqTitle" class="form-control" value="${modifaq.faqTitle }" aria-label="Text input with segmented dropdown button">
                        </div>   

                        <div class="input-group mb-3">
                            <span class="input-group-text notice-regist-title">작성자</span>
                            <input type="text"  name="FaqWriter" class="form-control" value="${modifaq.faqTitle }" aria-label="Text input with segmented dropdown button" readonly>
                        </div>   

 						<div class="input-group mb-3">
                            <input type="text" class="form-control" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" name="File" value="${modifaq.faqFileReal }" >
                        ...
                        <div class="notice-regi-text">
                            <textarea class="form-control" name="FaqContent" placeholder="공지사항 내용 입력" id="floatingTextarea" style="height: 500px">${modifaq.faqContent }</textarea>
                        </div>
                    </div>
			...
			<div class="input-group mb-3" style="display:none">
				...
				<input type="text" class="form-control" aria-label="Text input with segmented dropdown button" name="FaqNum" value="${modifaq.faqNum }">
        	</div>
    </section>
</form>
</div>
...
<script>
	$(function() {
		...
		$('#modiBtn').click(function(){
			// 작성자가 session에 등록한 사용자일 때만 허용(조건문 작성 ) 
			
			if (confirm('질문을 수정하시겠습니까? ')){
				document.faqmodiForm.submit();
			}
			else{
				return;
			}
