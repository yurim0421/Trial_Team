    ...
    <div class="container py-5">
        ...
        <!-- End 사이드 바-->
            ...
            <div class="col-lg-9">
                ...
                <form class="m-auto form-total-box" id="mypageForm" action="<c:url value='/user/mypagePersonModif'/>" role="form">
                    ...
                    <div class="total-box">
                    	...
                    	<div class="boxbox">
                            ...
                            <div class="box2 JOINID" name="JOINID" value="">${user.JOINID}</div>
                        </div>
                        ...
                        <div class="boxbox">
                            ...
                            <div class="box2 joinBirth" id="birthday" name="JOINSOCNUM">${user.JOINSOCNUM.substring(0,2)}년 ${user.JOINSOCNUM.substring(2,4)}월 ${user.JOINSOCNUM.substring(4,7)}일 </div>
                        </div>
                        <div class="boxbox">
