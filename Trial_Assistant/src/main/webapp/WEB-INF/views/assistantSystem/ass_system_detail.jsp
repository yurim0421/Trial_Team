...
<body>
    ...
    <form class="form-total">
        ...
        <div class="table-box col-lg second-section">
            ...
            <div class="ass-part">
                <label class="ass-label">조력자 제도 정의</label>
            ...
            <div class="ass-part">
                <label class="ass-label">일반 조력자 안내</label>
                <div class="form-floating">
            ...
            <div class="ass-part">
                <label class="ass-label">통 번역인 안내</label>
                <div class="form-floating">
            ...
            <div class="ass-part">
                <label class="ass-label">기관 추천 조력자 안내</label>
                <div class="form-floating">
            ...
            <div class="ass-part">
                <label class="ass-label">부적격자 안내</label>
                <div class="form-floating">
